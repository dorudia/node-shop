...
const store = new MongoDBStore({
  uri: process.env.MONGODB_URL, // folosește variabila de mediu
  collection: "sessions",
});

// Opțiuni TLS pentru Mongoose
const mongooseOptions = {
  useNewUrlParser: true,
  useUnifiedTopology: true,
  tls: true, // forțează TLS
  tlsAllowInvalidCertificates: false, // important pentru Atlas
...
module.exports = app; // rămâne pentru Render
